...
## annotation.py 要把xml做成這樣 路徑、[[座標]] 、[<name>]
# tuple(e:\aiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii\Tensorflow\第八章\YOLO\data\img\1.png [[43  7 62 37]] [5])
